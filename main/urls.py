...
urlpatterns = [
    ...
    path('staff/question-reports/', views.staff_question_reports, name='staff_question_reports'),
    path('staff/question-reports/<int:report_id>/', views.staff_question_report_detail, name='staff_question_report_detail'),
